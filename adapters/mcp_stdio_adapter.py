...
from tools.token.schema import GetTokenParams, GetWalletTokensParams
...
#         print("[CoreonMCP] Server stopped by user", file=sys.stderr)
#     except Exception as e:
#         print(f"[CoreonMCP] Server error: {e}", file=sys.stderr)